...
| wordle__font_path | 否 | `./resources/FiraCode-Medium.ttf` | 字体文件路径 |
| wordle__dictionary_answer_path | 否 | `./resources/DictionaryAnswer.txt` | 答案词库路径 |
| wordle__dictionary_guess_path | 否 | `./resources/DictionaryGuess.txt` | 猜词词库路径 |
